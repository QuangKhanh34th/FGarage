        ...
        <aside id="sidebar">
            <div class="d-flex">
                ...
                <div class="sidebar-logo">
                    <a href="${pageContext.request.contextPath}/SalesDashboard/home.jsp">FGarage</a>
                </div>
            </div>
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    ...
                    <ul id="customer-multi" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item">
                            <a href="${pageContext.request.contextPath}/SalesDashboard/CarFunction.jsp" class="sidebar-link">
                                <i class="bi bi-car-front"></i>
                                Cars
                            </a>
                        </li><li class="sidebar-item">
                            <a href="${pageContext.request.contextPath}/SalesDashboard/InvoiceFunction.jsp" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="${pageContext.request.contextPath}/SalesDashboard/ServiceTicketFunction.jsp" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="${pageContext.request.contextPath}/ReportServlet" class="sidebar-link">
