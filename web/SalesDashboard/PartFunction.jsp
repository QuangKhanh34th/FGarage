...
h2>Quản lý Phụ Tùng</h2>
        ...
        <table>
            ...
            %>
            <tr>
                <td colspan="5" class="message error">Lỗi khi tải dữ liệu phụ tùng.</td>
            </tr>
            <%
            ...
            <tr>
                ...
                <td>
                    <form action="PartServlet" method="POST" style="display:inline;">
                        ...
                        <input type="number" id="purchasePrice" name="purchasePrice" step="0.01" value="<%= part.getPurchasePrice()%>">
                        <hr/>
                        <label for="retailPrice">Giá bán:</label>
                        <input type="number" id="retailPrice" name="retailPrice" step="0.01" value="<%= part.getRetailPrice()%>">
                        <hr/>
        ...
        <br>
        <a href="index.html">Quay lại Trang Chủ</a>            </div>
        </div>
    </body>
</html>
